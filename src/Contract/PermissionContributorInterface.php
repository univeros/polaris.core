 ...
 *
 * Polaris owns only the identity/tenant permissions (see {@see \Polaris\Authorization\PermissionCatalog}).
 * A host that needs, say, `billing.manage` implements this interface and registers it; the
 * {@see \Polaris\Authorization\PermissionCatalog} merges the contributions, and the seed
